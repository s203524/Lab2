...
public class SpellCheckerController {
    ...
    void initialize() {
        ...
        assert btSpellCheck != null : "fx:id=\"btSpellCheck\" was not injected: check your FXML file 'SpellChecker.fxml'.";
        assert txtOutput != null : "fx:id=\"txtOutput\" was not injected: check your FXML file 'SpellChecker.fxml'.";
        assert lblEsito != null : "fx:id=\"lblEsito\" was not injected: check your FXML file 'SpellChecker.fxml'.";
        assert btClearText != null : "fx:id=\"btClearText\" was not injected: check your FXML file 'SpellChecker.fxml'.";
